...
def main():
    ...
    programme  = data.get('programme','Aarhi Impact Foundation Programme')
...
<div style="max-width:600px;margin:0 auto;background:#fff;">
  <div style="background:#0D3B3E;padding:32px 40px;">
    <div style="font-size:28px;color:#fff;font-weight:bold;">Aarhi Impact Foundation</div>
    <div style="font-size:11px;color:#9DC4C6;letter-spacing:0.2em;text-transform:uppercase;margin-top:4px;">Community · Conservation · Climate</div>
  </div>
  <div style="height:3px;background:#E8A838;"></div>
  <div style="padding:40px;">
    <div style="font-size:18px;color:#0D3B3E;font-weight:bold;margin-bottom:16px;">Dear {first_name},</div>
    <p style="font-size:14px;color:#2E3355;line-height:1.7;margin-bottom:14px;">
      ...
      offered by Aarhi Impact Foundation{collab_text}.
      We are pleased to present your official certificate.
    </p>
    <div style="background:#ECF3F3;border-left:4px solid #0D3B3E;padding:20px 24px;border-radius:2px;margin:24px 0;">
      <div style="font-size:10px;color:#8A8FA8;letter-spacing:0.16em;text-transform:uppercase;margin-bottom:3px;">Certificate</div>
      <div style="font-size:14px;color:#0D3B3E;font-weight:bold;margin-bottom:4px;">{cert_type}</div>
      {collab_html}
      <div style="font-size:10px;color:#8A8FA8;letter-spacing:0.16em;text-transform:uppercase;margin:12px 0 3px;">Track</div>
      <div style="font-size:14px;color:#0D3B3E;font-weight:bold;margin-bottom:12px;">{track}</div>
      ...
      <div style="font-size:14px;color:#0D3B3E;font-weight:bold;margin-bottom:12px;">{cert_id}</div>
      <div style="font-size:10px;color:#8A8FA8;letter-spacing:0.16em;text-transform:uppercase;margin-bottom:3px;">Issue Date</div>
      <div style="font-size:14px;color:#0D3B3E;font-weight:bold;">{issue_date}</div>
    </div>
    ...
    <a href="https://verify.aarhiimpactfoundation.org" style="display:inline-block;padding:14px 32px;background:#0D3B3E;color:#fff;text-decoration:none;border-radius:2px;font-size:13px;letter-spacing:0.12em;text-transform:uppercase;margin:8px 0 24px;">Verify Certificate</a>
    ...
    <p style="font-style:italic;color:#6B7280;font-size:13px;margin:20px 0;">With best wishes for your continued growth and contribution.</p>
    <div style="margin-top:32px;padding-top:20px;border-top:1px solid #ECF3F3;">
      <div style="font-size:15px;color:#0D3B3E;font-weight:bold;">Team Aarhi Impact Foundation</div>
      <div style="font-size:12px;color:#8A8FA8;margin-top:2px;">Aarhi Impact Foundation · Guwahati, Assam</div>
      <div style="font-size:12px;color:#8A8FA8;margin-top:2px;">12A · 80G · CSR-1 Registered</div>
    </div>
  </div>
